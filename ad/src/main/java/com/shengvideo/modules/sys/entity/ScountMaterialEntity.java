 ...
 */
@TableName("stb_count_material")
public class ScountMaterialEntity implements Serializable {
	...
	public ScountMaterialEntity(){

	}

	public ScountMaterialEntity(Long materialId,Long stbId,Date playTime){
