...
import com.shengvideo.common.validator.Assert;
import com.shengvideo.common.validator.ValidatorUtils;
import com.shengvideo.common.validator.group.AddGroup;
import com.shengvideo.common.validator.group.UpdateGroup;
import com.shengvideo.modules.sys.entity.SysRoleEntity;
import com.shengvideo.modules.sys.entity.SysUserEntity;
import com.shengvideo.modules.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R list(@RequestParam Map<String, Object> params){
        ...
        for (Object obj : page.getList()){
            ...
            user.setMenus(sysUserService.queryAllMenu(user.getUserId()));
        }
	...
	@GetMapping("/l")
	@RequiresPermissions("sys:user:list")
	public R l(@RequestParam Map<String, Object> params){
		//只有超级管理员，才能查看所有管理员列表
		/**
		 * TODO 需区分超级用户与普通用户
		 */

		return R.ok().put("data", sysUserService.selectByMap(params));
	}
	...
	public R info(@PathVariable("userId") Long userId){
		...
		SysRoleEntity role = roleService.getByUser(userId);
		if(role == null) {
            user.setMenuIdList(new ArrayList<>());
        }else {
            user.setMenuIdList(roleMenuService.queryMenuIdList(role.getRoleId()));
        }
