...
import com.shengvideo.modules.sys.dao.SysRoleDao;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleDao, SysRoleEntity> implements SysRoleService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public SysRoleEntity getByUser(Long uid) {
	    Map<String,Object> param = new HashMap<>();
	    param.put("uid",uid);
	    param.put("type",2);
	    List<SysRoleEntity> list = selectByMap(param);
	    if (list.isEmpty()) {
	        return null;
        }
        return list.get(0);
    ...
    @Override
    public void updateRoleOnly(SysRoleEntity role) {
        this.updateById(role);
    }
